...
export default function ProductCard({ heading, content, imageUrl }) {
  return (
    <div className="rounded-4xl shadow-sm hover:scale-100 bg-[#275123] text-white hover:shadow-lg transition-all duration-300 ease-in-out flex flex-col p-1.5 hover:cursor-pointer">
      ...
      <div className="px-4">
        ...
        <p className="flex items-center text-xs underline gap-1">order now <span><GoArrowUpRight /></span></p>
        </div>
