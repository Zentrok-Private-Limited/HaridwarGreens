...
function Header() {
  return (
    <div className='fixed top-0 left-0 right-0 z-50 font-semibold text-base flex justify-between items-center px-4 py-3 bg-transparent backdrop-blur-lg rounded-lg'>
        <div>
